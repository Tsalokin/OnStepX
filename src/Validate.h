...
#if AXIS4_SLEW_RATE_BASE_DESIRED < 100 || AXIS4_SLEW_RATE_BASE_DESIRED > 5000
  #error "Configuration (Config.h): Setting AXIS4_SLEW_RATE_BASE_DESIRED out of range, use a value between 100 and 5000"
#endif
